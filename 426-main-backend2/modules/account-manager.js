...
exports.actLookup = function(key, callback) {
	accounts.findOne({activation_key: key}, function(e, w) {
		if (e) callback(e)
...
exports.usernameLookup = function(username, callback) {
	accounts.findOne({user: username}, function(e, q) {
		if (e) callback(e)
...
{
	accounts.findOne({_id: getObjectId(id)}, function(e, q) {
		if (e) {
...
{
	accounts.deleteOne({user: id}, callback);
}
